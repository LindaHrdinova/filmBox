const filmy = [
  ...
  },
  {
    ...
    popis:
      'Na zámek v podhůří Krkonoš přijíždí jeho nový majitel Štěpán se svojí snoubenkou, krásnou komtesou Blankou, a mladším bratrem Adamem. Cestou kočár nešťastně srazí kolemjdoucí dívku, Adam jí pomůže a ona se do něj zamiluje. Na zámku Adam objeví starou vlašskou knihu, která by měla obsahovat cestu k pokladům. Tajemné značky vlašské knihy však nedokáže vyluštit ani národopisec Jiráček, který v kraji sbírá pověsti a nevychází z údivu nad tím, že zdejší lidé stále věří v Krakonoše. Na zámku se objeví záhadný cizinec a nabídne Štěpánovi, že jej k pokladu za určitých podmínek dovede. Výprava do hor může začít. Naplní se Liduščina láska k Adamovi? Jakou záhadu skrývá starý obraz na zámku Hůrka a co strašlivého se v horách kdysi odehrálo? ochutnavkaA kdo je vlastně Krakonoš a jaké je jeho největší tajemství? (csfd.cz, Česká televize)',
    premiera: '2022-12-24',
  },
  {
    id: 'pripoutejte-se-prosim',
    nazev: 'Připoutejte se, prosím!',
    plakat: {
      url: 'https://image.pmgstatic.com/cache/resized/w420/files/images/film/posters/158/494/158494389_fd1b24.jpg',
      sirka: 420,
      vyska: 592,
    },
    ochutnavka: 'Bláznivá americká parodie na katastrofické příběhy.',
    popis:
...
filmy.forEach((film) => {
  return (seznamFilmuELm.innerHTML += `
		<div class="col">
      <div class="card">
        <img
          src="${film.plakat.url}"
        ...
        <div class="card-body">
          ...
          <a href="film.html#${film.id}" class="btn btn-primary">
            Přehrát
          </a>
        </div>
      </div>
